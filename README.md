...
| Date       | Release Notes    |
| ---------- | ---------------- |
| 2026.07.30 | Layouts and Themes changeable while running, various fixes to touchscreen, font glyph fallback behaviour, battery functions simplified, playlist verification, localization 100%? |
