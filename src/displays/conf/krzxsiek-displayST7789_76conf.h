...
const ScrollConfig metaConf       PROGMEM = {{ TFT_FRAMEWDT+1, TFT_FRAMEWDT, 2, WA_LEFT }, 140, true, MAX_WIDTH-2, 5000, 2, 25 };
const ScrollConfig title1Conf     PROGMEM = {{ TFT_FRAMEWDT+1, 21, 1, WA_LEFT }, 135, true, DSP_WIDTH/2+18, 5000, 2, 25 };
const ScrollConfig title2Conf     PROGMEM = {{ TFT_FRAMEWDT+1, 32, 1, WA_LEFT }, 135, true, DSP_WIDTH/2+18, 5000, 2, 25 };
...
const ScrollConfig weatherConf    PROGMEM = {{ TFT_FRAMEWDT+1, DSP_HEIGHT-12, 1, WA_CENTER }, 140, true, MAX_WIDTH-2, 0, 2, 30 };
...
const WidgetConfig bitrateConf    PROGMEM = { TFT_FRAMEWDT+21, 63-10-10, 1, WA_LEFT };

/* FOOTER */
const WidgetConfig iptxtConf     PROGMEM = { TFT_FRAMEWDT, 64-11, 1, WA_LEFT };
const WidgetConfig voltxtConf     PROGMEM = { TFT_FRAMEWDT+110, 63-10-10, 1, WA_LEFT };  // Hangerő
const WidgetConfig chtxtConf      PROGMEM = { TFT_FRAMEWDT+70, 63-10-10, 1, WA_LEFT }; //→ aktualny kanał CH:text (stopka PLAYER)
const WidgetConfig rssiConf       PROGMEM = { TFT_FRAMEWDT+1, 63-10-10, 1, WA_LEFT };

const WidgetConfig numConf        PROGMEM = { TFT_FRAMEWDT, 59, 0, WA_CENTER };
